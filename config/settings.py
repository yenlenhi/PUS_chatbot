...
PDF_GEMINI_MAX_RETRIES = int(os.getenv("PDF_GEMINI_MAX_RETRIES", "4"))
PDF_GEMINI_RETRY_DELAY_SECONDS = float(
    os.getenv("PDF_GEMINI_RETRY_DELAY_SECONDS", "2")
)
PDF_GEMINI_PAGE_DELAY_SECONDS = float(
    os.getenv("PDF_GEMINI_PAGE_DELAY_SECONDS", "0")
)
PDF_GEMINI_REQUEST_INTERVAL_SECONDS = float(
    os.getenv("PDF_GEMINI_REQUEST_INTERVAL_SECONDS", "1.5")
)
PDF_GEMINI_RATE_LIMIT_COOLDOWN_SECONDS = float(
    os.getenv("PDF_GEMINI_RATE_LIMIT_COOLDOWN_SECONDS", "20")
)
PDF_GEMINI_MAX_BACKOFF_SECONDS = float(
    os.getenv("PDF_GEMINI_MAX_BACKOFF_SECONDS", "60")
)
