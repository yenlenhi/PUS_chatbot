...
HEADING_CHUNK_MIN_SIZE = int(os.getenv("HEADING_CHUNK_MIN_SIZE", "400"))
HEADING_CHUNK_TARGET_SIZE = int(os.getenv("HEADING_CHUNK_TARGET_SIZE", "1600"))
HEADING_CHUNK_MAX_SIZE = int(os.getenv("HEADING_CHUNK_MAX_SIZE", "3500"))
